...
export default function Sidenav({ isOpen, onClose }: SidenavProps) {
  ...
  return (
    <aside className="z-50">
      <div
        className={`fixed h-screen overflow-y-scroll w-full bg-gray-900 transition duration-200 md:hidden ${
          isOpen
            ? "opacity-50 z-40 top-0 left-0"
            : "opacity-0 -z-10 top-0 left-0"
        }`}
        onClick={onClose}
      ></div>
      <div
        ...
        } transition duration-200 flex flex-col gap-8 p-4 h-screen w-80 fixed top-0 left-0 z-50 border-r-[1px] bg-white border-gray-200 md:hidden`}
      >
        <div className="flex justify-between items-center border-b-[1px] border-gray-200 pb-4">
          ...
          <button onClick={onClose} className="h-fit px-3 py-2 rounded-md">
          ...
          <li>
            ...
            <ul id="dropdown-profil" className="hidden py-2">
              <li className="p-4 font-semibold cursor-pointer text-sm text-gray-900 hover:text-blue-600">
                Tentang Khairul Tes Branch Pertama dan Komit Pertama
              </li>
              <li className="p-4 font-semibold cursor-pointer text-sm text-gray-900 hover:text-blue-600">
                Sejarah BBIHPMM
              </li>
